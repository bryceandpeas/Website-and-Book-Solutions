...
Numpy: https://www.hackerrank.com/challenges/np-linear-algebra/problem
...
print (float("{0:.2f}".format((numpy.linalg.det(numpy.matrix([input().split(' ') for i in range(int(input()))], dtype="float"))))))
