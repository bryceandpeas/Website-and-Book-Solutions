...
Date and Time: https://www.hackerrank.com/challenges/py-collections-namedtuple/problem

Hackerrank - Python -  Collections - Collections.namedtuple()
...
marks = [int(Student._make(input().split()).MARKS) for j in range(n)]
