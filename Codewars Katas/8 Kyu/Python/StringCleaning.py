...
Codewars Kata - 8 Kyu - Difference of Volumes of Cuboids
...
clean out all numeric characters, and return a string with spacing and special characters ~#$%^&!@*():;"'.,? all intact.
